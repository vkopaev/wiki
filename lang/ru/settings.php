...
return [
    ...
    'sort_rule_edit' => 'Изменить правило сортировки',
    ...
    'sort_rule_delete_warn_books' => 'Это правило сортировки в настоящее время используется в :count book(s). Вы уверены, что хотите удалить его?',
    ...
    'sort_rule_details_desc' => 'Задайте имя для этого правила сортировки, оно будет отображаться в списках, когда пользователи выбирают сортировку.',
    'sort_rule_operations' => 'Sort Operations',
    'sort_rule_operations_desc' => 'Настройка сортировки выполняемых действий путем перемещения их из списка доступных операций. После использования операции будут выполняться по порядку сверху вниз. Любые изменения, внесенные здесь, будут применены ко всем назначенным книгам после сохранения.',
    'sort_rule_available_operations' => 'Доступные операции',
    'sort_rule_available_operations_empty' => 'Операций не осталось',
    ...
    'sort_rule_op_name' => 'Имя - по алфавиту',
    'sort_rule_op_name_numeric' => 'По нумерации',
    'sort_rule_op_created_date' => 'По дате создания',
    'sort_rule_op_updated_date' => 'По дате обновления',
    'sort_rule_op_chapters_first' => 'Главы в начале',
    'sort_rule_op_chapters_last' => 'Главы в конце',
    'sorting_page_limits' => 'Ограничения показа на странице',
    ...
    'role_import_content' => 'Импортировать содержимое',
    'role_editor_change' => 'Изменение редактора страниц',
    'role_notifications' => 'Получение и управление уведомлениями',
    'role_permission_note_users_and_roles' => 'Эти разрешения также обеспечивают видимость и поиск пользователей и ролей в системе.',
